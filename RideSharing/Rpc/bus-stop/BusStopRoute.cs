...
{
    [DisplayName("BusStop")]
    public class BusStopRoute : Root
    {
        public const string Parent = Module + "/bus-stop";
        public const string Master = Module + "/bus-stop/bus-stop-master";
        public const string Detail = Module + "/bus-stop/bus-stop-detail";
        public const string Preview = Module + "/bus-stop/bus-stop-preview";
        private const string Default = Rpc + Module + "/bus-stop";
