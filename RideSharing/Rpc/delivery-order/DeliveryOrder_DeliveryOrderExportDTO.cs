...
{
    public class DeliveryOrder_DeliveryOrderExportDTO : DataDTO
    {
        ...
        public DeliveryOrder_DeliveryOrderExportDTO() {}
        public DeliveryOrder_DeliveryOrderExportDTO(DeliveryOrder DeliveryOrder)
        {
