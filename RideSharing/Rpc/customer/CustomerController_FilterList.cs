...
namespace RideSharing.Rpc.customer
{
    ...
    {
        [Route(CustomerRoute.FilterListNode), HttpPost]
        public async Task<List<Customer_NodeDTO>> FilterListNode([FromBody] Customer_NodeFilterDTO Customer_NodeFilterDTO)
        {
