...
namespace RideSharing.Rpc.delivery_route
{
    ...
    {
        [Route(DeliveryRouteRoute.SingleListCityFreighter), HttpPost]
        public async Task<List<DeliveryRoute_CityFreighterDTO>> SingleListCityFreighter([FromBody] DeliveryRoute_CityFreighterFilterDTO DeliveryRoute_CityFreighterFilterDTO)
        {
