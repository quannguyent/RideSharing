...
namespace RideSharing.Rpc.city_freighter
{
    ...
    {
        [Route(CityFreighterRoute.FilterListNode), HttpPost]
        public async Task<List<CityFreighter_NodeDTO>> FilterListNode([FromBody] CityFreighter_NodeFilterDTO CityFreighter_NodeFilterDTO)
        {
